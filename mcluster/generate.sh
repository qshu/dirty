...
./mcluster -N $Nstar -B $B -m 0.08 -m 1.4 -s 12345 -u $unit -C 5 -nbin 2 -T $T -o $NAME > log.gen
...
./mcluster -N $Nnomass -B 0 -m 0.08 -m 1.4  -s 54321 -u $unit -C 5 -nbin 2 -T $T  > test.log.gen
